...
const DisplaySearchResults = ({
  ...
  if (searchResultsLoading) {
    return (
      <div className="w-full absolute top-[130%] rounded-[10px] border-2 flex gap-4 items-center border-neutral-600 py-3 px-2 text-neutral-0">
  ...
  if (isNoResults) {
    return <div className="w-full absolute top-[170%] text-neutral-0 text-[1.5rem] font-medium text-center tracking-wide">No Search Results Found!</div>
  }
